	...
	<div class="top-bar">
		<div class="container">
			...
			<div class="tb-contact pull-left">
				<!-- Email -->
				<i class="fa fa-envelope color"></i> &nbsp; <a href="mailto:info@swiftmart.com">info@swiftmart.com</a>
				&nbsp;&nbsp;
				<!-- Phone -->
			...
			<div class="tb-social pull-right">
				<div class="brand-bg text-right">
					...
					<a href="#" class="instagram"><i class="fa fa-instagram square-2 rounded-1"></i></a>
				</div>
			</div>
			<!-- Social media ends -->
									...
									<div class="tp-banner tp-banner0">
										<ul>
											...
											<li data-link="#" data-target="_self" data-transition="flyin" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
												<!-- MAIN IMAGE --><img src="img/dummy.png" alt="slidebg1" data-lazyload="img/photos/Phones/huawei.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
												<!-- LAYER NR. 1 -->
											...
											<li data-transition="boxslide" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
												<!-- MAIN IMAGE --><img src="img/dummy.png" alt="slidebg1" data-lazyload="img/photos/Phones/s20x.png" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
												<!-- LAYER NR. 1 -->
...
<section id="popular-product" class="ecommerce">
	...
	<div class="bt-block-home-parallax" style="background-image: url(img/photos/bgnd.png);">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
